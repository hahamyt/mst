...
class ISTrainer(object):
    def __init__(self, model, cfg, model_cfg, loss_cfg,
        ...
        self.train_data = DataLoader(
            ...
            drop_last=True, pin_memory=True, prefetch_factor=4, persistent_workers=True,
    ...
    def training(self, epoch):
        ...
        tbar = tqdm(self.train_data, disable=not self.is_master, dynamic_ncols=True)
        ...
        if self.is_master:
            ...
            if epoch % checkpoint_interval == 0:
                save_checkpoint(
                    ...
                    verbose=True,
                    multi_gpu=self.cfg.distributed
                )
